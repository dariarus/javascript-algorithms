...
function anagram(str1, str2) {
    ...
    for (let str1CharIndex = 0; str1CharIndex < str1LowerCase.length; str1CharIndex++) {
        ...
        // replaceAll возвращает новую строку с замененными символами. И если к-л символ удален, ДЛИНА новой строки станет отличной от входящей
        ...
        let str1SymbolCount = str1LowerCase.length - str1LowerCase.replaceAll(symbol, '').length;
        let str2SymbolCount = str2LowerCase.length - str2LowerCase.replaceAll(symbol, '').length;
